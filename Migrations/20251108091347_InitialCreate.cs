...
namespace traq_web_project_assessment.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedDate", "FullName", "IsActive", "PasswordHash", "Username" },
                values: new object[] { 1, new DateTime(2025, 11, 8, 11, 13, 41, 746, DateTimeKind.Local).AddTicks(5024), "System Administrator", true, "AQAAAAEAACcQAAAAEBvZx1YHd8K9L0YxLYyYxYzQ8w==", "admin" });
